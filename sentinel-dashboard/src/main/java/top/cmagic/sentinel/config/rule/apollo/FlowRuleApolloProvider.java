...
//        String appId = "appId";
        ...
        OpenNamespaceDTO openNamespaceDTO = apolloOpenApiClient.getNamespace(appId, StringUtils.isNotEmpty(env)?env:"DEV",
                "default", StringUtils.isNotEmpty(namespace)?namespace:"application");
